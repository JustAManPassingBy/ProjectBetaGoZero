# Origin Source : github.com/Rockester-NRT/RocAlphaGo/AlphaGo/go_python.py
# Project "RockAlphaGo" is protected by MIT-License
...
class GameState(object):
    ...
    def get_winner(self):
        ...
        print(score_white, score_black, self.komi, self.passes_white, self.passes_black)
    ...
    def do_move(self, action, color=None):
        ...
        if self.is_legal(action):
            ...
            print(color, reset_player, self.board[mv_y, mv_x])
